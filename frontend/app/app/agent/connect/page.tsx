    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card className="space-y-4 p-5 text-sm">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">A 404 means this server has no prebuilt connector for your OS/arch — build it from the repository instead: <code>cd backend &amp;&amp; go build -o arena ./cmd/arena</code></p>
        </div>
