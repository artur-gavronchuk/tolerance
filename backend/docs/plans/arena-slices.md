...
> **Обновление 21 сентября 2026:** срезы 2–4 заменены планом MVP первого соревнования — [mvp/00-overview.md](mvp/00-overview.md). Срез 1 выполнен; описание срезов 2–4 ниже сохранено как история и не выполняется.
